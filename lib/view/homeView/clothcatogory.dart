...
class ClothCatogory extends StatefulWidget {
  String category;
  ClothCatogory({required this.category,super.key});

  @override
  State<ClothCatogory> createState() => _ClothCatogoryState();
}

class _ClothCatogoryState extends State<ClothCatogory> {
