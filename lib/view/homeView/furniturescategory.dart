...
class FurnituresCategory extends StatefulWidget {
  String category;
  FurnituresCategory({required this.category,super.key});

  @override
  State<FurnituresCategory> createState() => _FurnituresCategoryState();
}

class _FurnituresCategoryState extends State<FurnituresCategory> {
              ...
              child: FutureBuilder(
                  ...
                  builder: (context,snapshot) {
                    if(snapshot.connectionState == ConnectionState.waiting){
                      ...
                      return Center(child: Text('Some error happened !',style: TextStyle(
